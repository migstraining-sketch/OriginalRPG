...
namespace WoodlandSpine
{
    public class CharacterEntry : MonoBehaviour
    {
        ...
        void Start(){var args=System.Environment.GetCommandLineArgs();if(System.Array.IndexOf(args,"--slice-smoke")>=0||System.Array.IndexOf(args,"--intro-smoke")>=0||System.Array.IndexOf(args,"--opening-smoke")>=0)Enter();}
