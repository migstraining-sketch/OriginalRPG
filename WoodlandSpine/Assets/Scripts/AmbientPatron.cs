...
namespace WoodlandSpine
{
    public sealed class AmbientPatron : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {Vector3 direction=new Vector3(-4,transform.position.y,-2)-transform.position;if(direction.sqrMagnitude>.01f)transform.rotation=Quaternion.Slerp(transform.rotation,Quaternion.LookRotation(direction),Time.deltaTime*3);}
