...
namespace WoodlandSpine
{
    public class SampleDrop : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            transform.position=Vector3.Lerp(start,InnLayout.SampleFall,t*t);transform.Rotate(0,0,Time.deltaTime*180);
            if(t<1)return;
            ...
            for(int n=0;n<4;n++)world.Shape("Broken sample fragment",InnLayout.SampleFall+new Vector3(n*.11f,0,(n%2)*.17f),new Vector3(.1f,.04f,.16f),new Color(.51f,.6f,.52f),solid:false);
